...
namespace dso {
    ...
    void FullSystem::flagFramesForMarginalization(FrameHessian *newFH) {
        ...
        for (int i = 0; i < (int) frameHessians.size(); i++) {
            ...
            FrameHessian *fhPrev = frameHessiansPrev[i];
            ...
            Vec4 refToFh = AffLight::fromToVecExposure(frameHessians.back()->ab_exposure, fh->ab_exposure, frameHessiansPrev.back()->ab_exposure, fhPrev->ab_exposure,
                                                       frameHessians.back()->aff_g2l(), fh->aff_g2l(), IR_Data);
...
//	printf("\n");
    ...
    void FullSystem::marginalizeFrame(FrameHessian *frame) {
        ...
        deleteOutOrder<FrameHessian>(frameHessians, frame);     // delete marginalized frame from frameHessians
