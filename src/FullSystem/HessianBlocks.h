...
#define SCALE_B_INVERSE (1.0f / SCALE_B)
    ...
    struct FrameFramePrecalc {
        ...
        void set(FrameHessian *host, FrameHessian *hostPrev, FrameHessian *target, FrameHessian *targetPrev,
                 CalibHessian *HCalib);
    };
    ...
    struct FrameHessian {
        ...
        inline void setEvalPT_scaled(const SE3 &worldToCam_evalPT,
                                     const AffLight &aff_g2l) // const AffLight &aff_g2l)     // JZ modification: affLight
        {
